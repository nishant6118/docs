---
title: "Policy Engine — AI Agent Policy Enforcement"
description: "Define rules that block, allow, or escalate any AI agent tool call. Configure policies by tool name, parameters, agent identity, spend threshold, or custom conditions. Evaluated in under 1ms."
---
